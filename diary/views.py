...
def home(request):
    ...
    records_count = len(repo.get_user_records(user.id)) if user else 0
...
def medicines(request):
    ...
    medicines_list =  repo.search_medicines_by_name(search)
    context = {
...
def users_list(request):
    ...
    context = {
        ...
        'users_count': repo.get_users_count(),
    }
